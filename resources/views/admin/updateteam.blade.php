...
@section('content')
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl font-semibold text-gray-800">Update Team Member</h1>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <form method="post" enctype="multipart/form-data" class="space-y-5">
                ...
                @if($data11->image)
                    <div>
                        ...
                        <div class="relative w-24 h-24 rounded-full overflow-hidden border border-gray-200">
                            <img src="{{ asset('img_uploads/' . $data11->image) }}" class="w-full h-full object-cover">
                        </div>
                    </div>
                @endif

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Change Profile Image (Optional)</label>
                ...
                <div>
                    ...
                    <input type="text" name="name" value="{{ $data11->name }}" placeholder="Enter full name"
                ...
                <div>
                    ...
                    <input type="text" name="dsg" value="{{ $data11->dsg }}" placeholder="e.g. Manager, Receptionist"
                        class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all">
                </div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit"
                        ...
                        <i data-feather="check" style="width:16px;height:16px;stroke-width:2.5;"></i> Update Member
                    </button>

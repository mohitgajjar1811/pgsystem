                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-3 text-right">
                        <div class="flex items-center justify-end gap-2">
                            <a href="/admin/updateteam/{{ $i->id }}" class="p-1.5 text-gray-400 hover:text-gray-900 transition-colors">
                                <i data-feather="edit-3" style="width:16px;height:16px;"></i>
                            </a>
                            <a href="/admin/deleteteam/{{ $i->id }}" class="p-1.5 text-gray-400 hover:text-red-600 transition-colors" onclick="return confirm('Delete this team member?')">

                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="room-item shadow rounded overflow-hidden">
                                    <div class="position-relative">
                                        <img class="img-fluid" src="{{ asset('img_uploads/' . $i->image) }}" alt="Room Image"
                                    ...
                                    <div class="p-4 mt-2">
                                        ...
                                        <div class="room-desc-wrapper mb-3">
                                            <p class="text-body mb-1 room-desc"
                                                style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; transition: all 0.3s ease;">
                                                {{ $i->detail }}</p>
                                            <a href="javascript:void(0);" class="read-more-btn text-primary"
                                                style="display: none; font-size: 14px; font-weight: 600; text-decoration: none;">Read
                                                More</a>
                                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="service-item rounded" href="/loadservice">
                            ...
                            <p class="text-body mb-0">Ready to experience the comfort and convenience of our paying
                                guest
                                accommodation? Contact us today to book your room and start enjoying a hassle-free stay
                                in a
                        ...
                        <div class="owl-carousel testimonial-carousel py-5">
                            ...
                            {{-- <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                                <p>Tempor stet labore dolor clita stet diam amet ipsum dolor duo ipsum rebum stet dolor
                                    amet diam stet. Est stet ea lorem amet est kasd kasd et erat magna eos</p>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid flex-shrink-0 rounded"
                                        src="{{ asset('img/testimonial-3.jpg') }}" style="width: 45px; height: 45px;">
                                    <div class="ps-3">

                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="/loadroom" class="nav-item nav-link">Explore Rooms</a>
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <h5 class="mb-0">
                                        <span
                                            style="background-color: red; color: white; padding: 5px; border-radius: 5px;">Remaining
                                            Bads: 2</span>
                                    </h5>
                                    <!--                        <div class="ps-2">-->
                    ...
                    <div class="row g-5">
                        <div class="col-md-6 col-lg-4">
                            <div class="bg-primary rounded p-4">
                                <a href="index.html">
                                    <h1 class="text-white text-uppercase mb-3">SUNRISE PG</h1>
                                </a>
                                <p class="text-white mb-0">
                                    Located in the heart of Ahmedabad. Ideal for students and professionals alike, our
                                    PG offers a convenient and comfortable living space with all the necessary
                                    amenities.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 col-md-12">
                            <div class="row gy-5 g-4">
                                <div class="col-md-6">
                                    <h6 class="section-title text-start text-primary text-uppercase mb-4">Paying
                                        Guest</h6>

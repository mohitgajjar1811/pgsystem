                    ...
                    <div class="row gx-0 bg-white d-none d-lg-flex">
                        ...
                        <div class="col-lg-5 px-5 text-end">
                            <div class="d-inline-flex align-items-center py-2">
                                ...
                                <button type="button" class="btn btn-black" ><a href="/logout">logout</a></button>
                                @else
                                <!-- If user is not logged in, show login link -->
                                <button type="button" class="btn btn-black" ><a href="/loadlogin">login</a></button>
                                @endif
<!--                                    <button type="button" class="btn btn-black" ><a href="/loadlogin">login</a></button>&nbsp; &nbsp;-->
<!--                                    <button type="button" class="btn btn-black" ><a href="/loadragistration">Singup</a></button>-->
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="/loadservice" class="nav-item nav-link active">Services</a>
                                <a href="/loadroom" class="nav-item nav-link">Explore Recidency</a>
                                <div class="nav-item dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Pages</a>
                                    <div class="dropdown-menu rounded-0 m-0">
<!--                                        <a href="/loadbooking/1%20Sharing" class="dropdown-item">Booking</a>-->
                                ...
                                <a href="/loadcontact" class="nav-item nav-link">Contact</a>
                            </div>
                        </div>
                    </nav>
                </div>
...
<!--        &lt;!&ndash; Booking End &ndash;&gt;-->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="service-item rounded wow fadeInUp" data-wow-delay="0.1s">
                    <a href="" class="service-icon bg-transparent border rounded p-1">
                        <div class="w-100 h-100 border rounded d-flex align-items-center justify-content-center">
                            <i class="fa fa-hotel fa-2x text-primary"></i>
                        </div>
                    </a>
                    <h5 class="mb-3">Rooms</h5>
                    <p class="text-body mb-0">Ready to experience the comfort and convenience of our paying guest accommodation? Contact us today to book your room and start enjoying a hassle-free stay in a welcoming environment.</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="service-item rounded wow fadeInUp" data-wow-delay="0.2s">
                    <a href="" class="service-icon bg-transparent border rounded p-1">
                        <div class="w-100 h-100 border rounded d-flex align-items-center justify-content-center">
                    ...
                    <p class="text-body mb-0">Welcome to our SUNRISE PG Wi-Fi facility, designed to provide seamless connectivity and convenience for all our residents."Discover a world of digital possibilities with our hostel's Wi-Fi network".</p>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="service-item rounded wow fadeInUp" data-wow-delay="0.3s">
                    <a href="" class="service-icon bg-transparent border rounded p-1">
                        <div class="w-100 h-100 border rounded d-flex align-items-center justify-content-center">
                    ...
                    <p class="text-body mb-0">Our library facility is designed to cater to the diverse interests and academic needs of our residents, providing a quiet and conducive environment for study, research, or leisure reading.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="container pb-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
								Located in the heart of Ahmedabad. Ideal for students and professionals alike, our PG offers a convenient and comfortable living space with all the necessary amenities.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p class="mb-2"><i class="fa me-3"></i>&nbsp;&nbsp;&nbsp;Gujarat.</p> <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 7016853819</p>

...
<body>
    ...
    <script>
        ...
        // Display the total amount on the success page
        document.addEventListener("DOMContentLoaded", function () {
            var successDescription = document.querySelector('.success-description');
            successDescription.textContent = "Total Amount Paid: " + totalAmount + " INR";
        });
    </script>
</body>

                    ...
                    <div class="row gx-0 bg-white d-none d-lg-flex">
                        ...
                        <div class="col-lg-5 px-5 text-end">
                            <div class="d-inline-flex align-items-center py-2">
                                ...
                                @endif
<!--                                <button type="button" class="btn btn-black" ><a href="/loadlogin">login</a></button>&nbsp; &nbsp;-->
<!--                                <button type="button" class="btn btn-black" ><a href="/loadregistration">Singup</a></button>-->
<!--                                    <button type="button" class="btn btn-black" ><a href="/loadlogin">login</a></button>&nbsp; &nbsp;-->
<!--                                    <button type="button" class="btn btn-warning">singup</button>-->
...
<!--                                        <a href="/loadbooking/1%20Sharing" class="dropdown-item">Booking</a>-->
                                        ...
                                        <a href="loadtestimonial" class="dropdown-item active">Testimonial</a>
                                    </div>
                                </div>

                    ...
                    <div class="row gx-0 bg-white d-none d-lg-flex">
                        ...
                        <div class="col-lg-5 px-5 text-end">
                            <div class="d-inline-flex align-items-center py-2">
                                ...
                                @endif
                                    &nbsp; &nbsp;
<!--                                    <button type="button" class="btn btn-black" ><a href="/loadragistration">Registration</a></button>-->
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="/loadabout" class="nav-item nav-link active">About</a>
                                <a href="/loadservice" class="nav-item nav-link">Services</a>
                                <a href="/loadroom" class="nav-item nav-link">Explore Residency</a>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <p class="mb-4">Located in the heart of Ahmedabad. Ideal for students and professionals alike, our PG offers a convenient and comfortable living space with all the necessary amenities.</p>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="bg-primary rounded p-4">
                            ...
                            <p class="text-white mb-0">
                                Located in the heart of Ahmedabad. Ideal for students and professionals alike, our PG offers a convenient and comfortable living space with all the necessary amenities.
							</p>
                        </div>
                    </div>
